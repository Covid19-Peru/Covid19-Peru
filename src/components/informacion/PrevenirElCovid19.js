        ...
        <div className="container marketing">
            <div className="row">
                <div className="col-lg5">
                    ...
                    <p> Por el MINSA</p> 
                    <p> </p> 
                    <img className="bd-placeholder-img rounded-circle" alt="Recomendaciones1" width="140" height="140" src={Foto5}  focusable="false" role="img" aria-label="Placeholder: 140x140"></img>
                    <p> </p>
                ...
                <p> </p>
                <img className="bd-placeholder-img rounded-circle" alt="Recomendaciones2" width="140" height="140"  src={Foto6} focusable="false" role="img" aria-label="Placeholder: 140x140"></img>
                <p> </p>
                ...
                <div className="col-lg-4">
                <p> </p>
                <img className="bd-placeholder-img rounded-circle" alt="Recomendaciones3" width="140" height="140" src={Foto7}  focusable="false" role="img" aria-label="Placeholder: 140x140"></img>
                <p> </p>
                    <h2>3. UTILIZA PAÑUELOS DESECHABLES TÍRALOS A LA PAPELERA</h2>
                </div>

                <div className="col-lg-4">
                <img className="bd-placeholder-img rounded-circle" alt="Recomendaciones4" width="140" height="140" src={Foto8}  focusable="false" role="img" aria-label="Placeholder: 140x140"></img>
                <p> </p>
